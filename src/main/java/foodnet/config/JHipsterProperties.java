...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "foodnet@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "foodnet API";

        private String description = "foodnet API documentation";
